...
export interface ReportBusinessQO {
  ...
  * 流程模板id
  */
  workflowTmpId?: number;
_workflowTmpId?: number;
}
...
_employeeId?: string;
  ...
  */
  leaderDeptId?: number;
_leaderDeptId?: number;

  /**
  * 主职位
  */
  leaderPostId?: number;
_leaderPostId?: number;
...
_serviceItemId?: string;
  ...
  */
  createUserId?: number;
_createUserId?: number;

  /**
  * 创建部门ID
  */
  createDeptId?: number;
_createDeptId?: number;
